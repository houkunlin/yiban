  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    $PHPMAILER_LANG = array(
      'provide_address' => '邮箱地址不完整.',
      'mailer_not_supported' => '不支持mailer.',
      'execute' => '执行动作失败:',
      'instantiate' => '初始化EMAIL失败.',
      'authenticate' => 'SMTP验证失败.',
      'from_failed' => '收信人地址错误:',
      'recipients_failed' => '数据不被SMTP接受#2:',
      'data_not_accepted' => '数据不被SMTP接受#1:',
      'connect_host' => '不能连接SMTP服务器.',
      'file_access' => '打开文件失败#2:',
      'file_open' => '打开文件失败#:1',
      'encoding' => '未知编码:',
      'signing' => '签名失败:',
      'smtp_error' => 'SMTP服务器错误:',
      'empty_message' => '邮件内容为空',
      'invalid_address' => '收信人地址为空',
      'variable_set' => '无法重置变量:'
    );
